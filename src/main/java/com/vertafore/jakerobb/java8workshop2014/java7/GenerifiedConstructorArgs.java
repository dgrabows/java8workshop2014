...
public class GenerifiedConstructorArgs<X> {
    <T> GenerifiedConstructorArgs(T t) {
        // do something;
    }

    public static void main(String[] args) {
        // inferring X = Integer (you could do this in 6)
        // AND T = String (you couldn't do this!)
        GenerifiedConstructorArgs<Integer> myObject = new GenerifiedConstructorArgs<>("");
    }
}
