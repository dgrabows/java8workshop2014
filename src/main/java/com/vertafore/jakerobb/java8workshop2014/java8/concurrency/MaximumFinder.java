...
 * Inc.
 */
package com.vertafore.jakerobb.java8workshop2014.java8.concurrency;

import com.vertafore.jakerobb.java8workshop2014.java7.ContrivedSyntaxExamples;
import com.vertafore.jakerobb.java8workshop2014.java7.forkjoinpool.RandomDataGenerator;
...
public class MaximumFinder extends RecursiveTask<Integer> {
    ...
    public static void main(String[] args) {
        ...
        // Java 8 adds a common pool
        final ForkJoinPool pool = ForkJoinPool.commonPool();

        // create a random data set
        long start = System.nanoTime();
        Integer[] data = pool.invoke(new RandomDataGenerator(1000, sequentialThreshold));
